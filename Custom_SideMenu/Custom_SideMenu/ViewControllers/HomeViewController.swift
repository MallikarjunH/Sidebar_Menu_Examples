...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "MyEmailsVC")
...
extension HomeViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "MyEmailsVC")
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "MyEmailsVC")
        case 2:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ProfileVC")
        case 3:
            // Books
            self.showViewController(viewController: UINavigationController.self, storyboardId: "SettingVC")
