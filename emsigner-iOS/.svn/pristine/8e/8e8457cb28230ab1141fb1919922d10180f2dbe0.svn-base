...
#define kDefaultBlurRadius                  0.1
#define kDefaultBlackMaskAlpha              0.1
#define kDefaultAnimationDuration           0
#define kDefaultAnimationBounceHeight       0
#define kDefaultAnimationBounceScale        0
